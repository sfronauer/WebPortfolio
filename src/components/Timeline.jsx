        ...
        <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical bg-base-200 rounded-xl">
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end">
              <time className="font-mono italic">Since 2023</time>
              <div className="font-black">
                Apprenticeship as an IT Specialist in Application Development at
                the Vocational School for IT Professions of Deggendorf
          ...
          <li>
            ...
            <div className="timeline-end md:mb-10">
              ...
              <div className="font-black">
                Realschule, Germany Secondary school diploma (Mittlere Reife)
              </div>
            </div>
            <hr />
          </li>
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end">
              ...
              <div className="font-black">Primary School, Germany</div>
            </div>
          </li>
        </ul>
      </div>
